...
class CommandExec(Tool):
    ...
    def _execute_background(
        ...
        *,
        ...
        # Give very short-lived commands a chance to fail immediately.
    ...
    def _terminate_process_tree(
        ...
        """
        Best-effort termination of the process group.

        POSIX:
            SIGTERM -> wait -> SIGKILL

        Windows:
            CTRL_BREAK_EVENT -> wait -> kill
        """
        ...
        try:
            ...
            # Final fallback for the direct process.
            try:
                process.kill()
            except (
                ProcessLookupError,
